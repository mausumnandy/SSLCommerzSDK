...
@class NSCoder;
@class NSBundle;
SWIFT_CLASS("_TtC13SSLCommerzSDK11CardScanner") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
@interface CardScanner (SWIFT_EXTENSION(SSLCommerzSDK)) <AVCaptureVideoDataOutputSampleBufferDelegate>
